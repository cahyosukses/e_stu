...
<body style="background: url('<?php echo base_url('static/images/yellow-line.png'); ?>'); font-family: verdana, arial; font-size: 14px;">
	<div style="text-align: center;">
		...
		<div style="padding: 0; font-size: 80px; line-height: 100px;">
			201<span style="font-size: 120px;">5</span>-201<span style="font-size: 120px;">6</span><br />
			Parent & Student<br />
			Handbook
		</div>
		<div style="padding: 5px 0;"><img src="<?php echo base_url('static/images/handbook-line.png'); ?>" style="width: 70%;" /></div>
		<div style="padding: 10px 0 10px 0; font-size: 20px; color: #ff6150; letter-spacing: 5px;">JAFARIA EDUCATION CENTER</div>
		<div style="padding: 50px 0 30px 0;"><img src="<?php echo base_url('static/images/handbook-logo.png'); ?>" style="width: 65%;" /></div>
	</div>
	...
	<div style="padding: 0 0 25px 0;">
		...
		<div class="cnt-listing" style="line-height: 32px;">
			<div class="left">•</div>
			<div class="right">
			...
			<div class="left">•</div>
			<div class="right">
				<strong>Absences</strong>: Parents must ensure that students attend the school regularly. Any absence should be reported promptly by completing the absence form on the parental dashboard. The completed form must be sent in before the school day begins. Punctuality and good attendance is mandatory. All unexcused absences will affect the student’s grade in each class.
			</div>
			<div class="clear"></div>
			<div class="left">•</div>
			<div class="right">
				<strong>Excused Absences</strong>: These include sickness, ziarat/hajj trips, and family emergencies. Absences will only be excused for a maximum of 3 times for the duration of the year. Any additional days will need to have a doctor’s note or a previous agreement between the parent and the administration. It is the responsibility of the parent and the student to obtain any missed assignments and schedule make-ups of any missed tests and quizzes
			</div>
			<div class="clear"></div>
			<div class="left">•</div>
			<div class="right">
				<strong>Late arrivals</strong>: Any student who arrives after 10:30 AM will be marked as late. Parents are required to sign in the logbook with security guard or at the administration office and provide reasons for being late. Students tardiness disrupts the teacher & class instructions, so we request the parents to bring their children to school on time. Each tardy after the 3rd offense will affect the grade of the student for each class.
			</div>
			<div class="clear"></div>
		</div>
	</div>
	...
	<div style="padding: 0 0 0 0;">
		<div class="cnt-listing" style="line-height: 25px;">
			<div class="left">•</div>
			<div class="right">
				<strong>Early Pickup</strong>: For early pickup, please call administration office prior to pickup and sign your child out. Parents are not allowed to call or make arrangements with their children and pick them up without informing the formation, which may affect their grade.
			</div>
			<div class="clear"></div>
			<div class="left">•</div>
			<div class="right">
			...
			<div class="left">•</div>
			<div class="right">
				<strong>Plagiarism</strong>: The work that the student submits as either homework, classwork, projects, and/or exams must be of their own work. If a student uses or paraphrases someone else’s work without citing the source, he/she will be subjected to disciplinary action.
			</div>
			<div class="clear"></div>
			<div class="left">•</div>
			<div class="right">
				<strong>Dress Code</strong>: All students, staff, teachers, volunteers and parents / visitors must adhere to Islamic dress code; no exception. Girls must wear loose pants, loose long tops to their knees with full sleeves and an appropriate scarf which is not transparent and covers all of their hair. In addition, girls shouldn’t wear clothing that consists of vibrant colors. For boys, no shorts or shirts with pictures or lyrics are allowed. Violation of this dress code will result in disciplinary action.
			</div>
			<div class="clear"></div>
			<div class="left">•</div>
			<div class="right">
	...
	<div>
		<div class="cnt-listing">
			...
			<div class="left">•</div>
			<div class="right">
				<strong>Weekly Quran Readings</strong>: Students in Intermediate I, Intermediate II, and Advance classes are required to read 15 minutes of Quran every day. The parent must log those minutes onto their dashboard. The parent will only be able to add logs for the current week. The log for the last week will be locked on Sunday 12:00 AM
			</div>
			<div class="clear"></div>
		</div>
	</div>
	...
	<div style="padding: 0px;">
		...
		<div class="cnt-listing">
			<div style="padding: 0 0 20px 0;">• Students breaking the school rules will be disciplined. Actions causing the disciplinary actions are, but not limited to,</div>
			<div class="left-less">•</div>
			<div class="right-less">Being disrespectful or misbehaving with staff/teachers</div>
			<div class="left-less">•</div>
			<div class="right-less">Not respecting other students</div>
			<div class="left-less">•</div>
			<div class="right-less">Not respecting other’s property</div>
			<div class="left-less">•</div>
			<div class="right-less">Not following the proper dress code</div>
			<div class="left-less">•</div>
			<div class="right-less">Not completing their coursework (homework, exams, projects etc)</div>
			<div class="left-less">•</div>
			<div class="right-less">Plagiarism/Cheating</div>
			<div class="left-less">•</div>
			<div class="right-less">Unauthorized use of electronic devices</div>
			<div class="left-less">•</div>
			<div class="right-less">The following is a breakdown of the disciplinary actions that will be enforced by the School’s Administration</div>
			<div style="padding: 0 0 0 30px;">
			
				<div class="left-less">•</div>
				<div class="right-less">1st Offense - The student will be given a verbal warning</div>
				<div class="left-less">•</div>
				<div class="right-less">2nd Offense - Parent will be notified through proper communication channels</div>
				<div class="left-less">•</div>
				<div class="right-less">3rd Offense - Student will be suspended and a meeting with the parent and the administration will be held to formulate a plan for the student.</div>
				<div class="left-less">•</div>
				<div class="right-less">4th Offense - Student will be expelled from the school indefinitely</div>
			
			</div>
		</div>
	</div>
	<div class="header">DISCIPLINARY ACTIONS</div>
	...
	<div class="footer" style="padding: 0px 5px 5px 5px; font-size: 12px;">
		<div style="padding: 0 0 5px 0; font-size: 14px;">7</div>
		<div style="float: left; width: 150px; text-align: left;">Jafaria Education Center</div>
		<div style="float: left; width: 360px;">1546 E La Palma Ave, Anaheim, CA 92805</div>
		<div style="float: left; width: 225px; text-align: right;"><a href="www.jafariaschool.org" style="color: #021eaa;">www.jafariaschool.org</a></div>
		<div class="clear"></div>
